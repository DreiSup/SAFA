  ...
  useEffect(() => {
    const fetchDataInicial = async () => {
      try {
        ...
        console.error("Error cargando velas SP500", err)
      }
    }
    fetchDataInicial()
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xl font-bold text-zinc-100">S&P 500</span>
      ...
      <CardContent className="pt-0">
        ...
        <div className="mt-4 grid grid-cols-4 divide-x divide-zinc-800 rounded-xl border border-zinc-800 bg-zinc-900/50">
          {[
            ...
            { label: "VOLUMEN", value: formatVolume(volume), color: "text-zinc-100" },
            {
              label: "CAMBIO 30D",
